...
<body cz-shortcut-listen="true" data-new-gr-c-s-check-loaded="14.1229.0" data-gr-ext-installed=""
    style="height: 6094px;">


    <div class="cursor" style="top: 724px; left: 558px;"></div>
    <div class="cursor-follower" style="top: 704px; left: 538px;"></div>
            ...
            <div class="header__inner">
                ...
                <div class="header__wrapper">
                    <div class="header__lang lang">
                        <div class="lang__top">
                            <img src="{{ asset('images/languages/english.png') }}" alt="">
                            <span>
                                English
                            </span>
                        ...
                        <div class="lang__box lang-box">
                            ...
                            <a class="lang-box__link" href="#">
                                <img src="{{ asset('images/languages/deutsch.png') }}" alt="">
                                <span>
                                    Deutsch
                                </span>
                            </a>
                            <a class="lang-box__link" href="#">
                                <img src="{{ asset('images/languages/espanol.png') }}" alt="">
                                <span>
                                    Español
                                </span>
                            </a>
                ...
                <nav class="aside__menu menu">
                    <ul class="menu__list">
                        <li class="menu__list-item">
                            <a class="menu__list-link menu__list-link--active" href="{{ route('home') }}" s="">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('blogs') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                                        <path id="Vector"
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('shop') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                                        <path id="Icon"
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('groups') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                                        <path id="Vector"
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('members') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                                        <path id="Vector"
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('courses') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                        ...
                        <li class="menu__list-item">
                            <a class="menu__list-link" href="{{ route('events') }}">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons">
                                        <path id="Vector"
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <g id="icons" clip-path="url(#clip0_215_18379)">
                                            ...
                                            <path id="Vector_3"
                                                ...
                                                stroke="white" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path id="Vector_4" d="M1.33325 1.33325L14.6666 14.6666" stroke="white"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                            </path>
                                        </g>
                                        <defs>
            ...
            <section class="main__popup " id="faq-popup">
                <div class="popup__inner">
                    ...
                    <div class="popup-content">
                        ...
                        <ul>
                            <li><i class="icon-book-open"></i><a href="{{ route('home') }}">How to Upload Your
                                    Portfolio </a>
                            </li>
                            <li><i class="icon-book-open"></i><a href="{{ route('home') }}">How to Start To Work</a>
                            </li>
                            <li><i class="icon-book-open"></i><a href="{{ route('home') }}">Get in touch with the
                                    Creator
                                    Support
                                    Team</a></li>
                        </ul>
                        <div class="form-help-links">
                            <a class="fl-btn btn_first" href="{{ route('home') }}">Browse all articles</a>
