@section('main')
        ...
        <div class="container">
            <div class="section-top__inner">
                ...
                <div class="section-top__img">
                    <img class="section-top__img-image" src="images/new/group-img-23.jpg" alt="img">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="blog-section__inner">
                    ...
                    <div class="blog-section-box__images blog-section-box-images">
                        <div class="blog-section-box-images__block blog-section-box-images-block">
                            <div class="blog-section-box-images-block__img">
                                <img class="blog-section-box-images-block__img-image" src="images/new/post1.jpg"
                                    alt="img">
                            </div>
                        ...
                        <div class="blog-section-box-images__block blog-section-box-images-block">
                            <div class="blog-section-box-images-block__img">
                                <img class="blog-section-box-images-block__img-image" src="images/new/post2.jpg"
                                    alt="img">
                            </div>
                            <p class="blog-section-box-images-block__text">
                ...
                <div class="blog-section__box blog-section-box">
                    ...
                    <div class="blog-section-box__images blog-section-box-images">
                        <div class="blog-section-box-images__block blog-section-box-images-block">
                            <div class="blog-section-box-images-block__img">
                                <img class="blog-section-box-images-block__img-image" src="images/group-img-25.jpg"
                                    alt="img">
                            </div>
                            <p class="blog-section-box-images-block__text">
                                Cryptomate: Wallet App design
                        ...
                        <div class="blog-section-box-images__block blog-section-box-images-block">
                            <div class="blog-section-box-images-block__img">
                                <img class="blog-section-box-images-block__img-image" src="images/group-img-26.jpg"
                                    alt="img">
                            </div>
                            <p class="blog-section-box-images-block__text">
                                Content Management Platform
    ...
    <section class="main__courses-section-instructor courses-section-instructor courses-section-instructor--blog">
        <div class="container">
            <div class="courses-section-instructor__inner">
                <div class="courses-section-instructor__img">
                    <img class="courses-section-instructor__img-image" src="images/member-icon-7.png" alt="img">
                </div>
                ...
                <div class="comments__item comments-item">
                    ...
                    <div class="comments-item__inner">
                        ...
                        <a class="comments-item__link" href="#">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.99935 11.3332L2.66602 7.99984L5.99935 4.6665" stroke="white" stroke-width="2"
                ...
                <div class="related__card card">
                    <div class="card__inner">
                        ...
                        <p class="card__description">
                            Companies across industries are competing to get noticed online. That’s why digital
                            marketing professionals are in demand and the need to retain talent is high on the
                            agenda for many HR professionals.
                        </p>
                ...
                <div class="related__card card">
                    <div class="card__inner">
                        <a class="card-box__poster" href="{{ route('blog-page') }}">
                            <img class="card-box__poster-img" src="images/new/post-img-4.jpg" alt="img">
                        </a>
                        <p class="card__suptext card__suptext--purple">
                            marketing
                        </p>
                        ...
                        <p class="card__description">
                            Our office is something we are pleased with. We consider it the little magnet; it is
                            wanting.
                        </p>
                        <ul class="card__list card-list">
                            <li class="card-list__item">
