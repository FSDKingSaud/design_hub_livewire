        ...
        <div class="container">
            <div class="section-top__inner">
                ...
                <div class="section-top__img">
                    <img class="section-top__img-image" src="images/course-img-3.jpg" alt="img">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="courses-section-overview__box courses-section-overview-box">
                            ...
                            <div class="courses-section-overview-box__img">
                                <img class="courses-section-overview-box__img-image"
                                    src="images/new/course-img-7.jpg" alt="img">
                            </div>
                        </div>
                        <div class="courses-section-overview__box courses-section-overview-box">
                            <h2 class="courses-section-overview-box__title">
                        ...
                        <div class="reviews__inner">
                            <div class="reviews__comment reviews-comment">
                                <div class="reviews-comment__img">
                                    <img class="reviews-comment__img-image" src="images/member-icon-21.png"
                                        alt="img">
                                </div>
                                <div class="reviews-comment__body reviews-comment-body">
                                    ...
                                    <p class="reviews-comment-body__text">
                                        A good combinatin of practical and theory. It took me out of my comfort
                                        zone
                        ...
                        <ul class="aside-cost-info__list">
                            ...
                            <li class="aside-cost-info__list-item">
                                <p class="aside-cost-info__list-text">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M18 20V10" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M12 20V4" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M6 20V14" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <span>
                                        Level
                                ...
                                <p class="aside-cost-info__list-text">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="white" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M16 2V6" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M8 2V6" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M3 10H8" stroke="white" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
