                ...
                <section class="event__about about-event">
                    <div class="about-event__box about-event-box">
                        ...
                        <div class="about-event-box__images">
                            <img class="about-event-box__images-img" src="images/group-img-19.jpg" alt="img">
                            <img class="about-event-box__images-img" src="images/group-img-24.jpg" alt="img">
                            <img class="about-event-box__images-img" src="images/group-img-27.jpg" alt="img">
                            <img class="about-event-box__images-img" src="images/group-img-28.jpg" alt="img">
                        </div>
                        <p class="about-event-box__text">
