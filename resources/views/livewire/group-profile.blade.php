                    ...
                    <ul class="section-top-content__list card-list">
                        ...
                        <li class="card-list__item">
                            <a class="card-list__link" href="#">
                                ...
                                <img class="card-list__link-img" src="images/member-icon-3.png" alt="img">
                            </a>
                        </li>
                    </ul>
            ...
            <div class="group-profile__inner">
                        ...
                        <div class="group-profile-posts__inner">
                                ...
                                <div class="post__body post-body">
                                    <div class="post-body__top post-body-top">
                                        <a class="post-body-top__link" href="#">
                                            <img class="post-body-top__link-img" src="images/member-icon-10.png"
                                                alt="img">
                                        </a>
                                    ...
                                    <div class="post-body__view post-body-view">
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/34525.jpg"
                                                alt="img">
                                        </a>
                                    </div>
                                    ...
                                    <div class="comments__inner">
                                        <div class="comments__wrapper">
                                            <div class="comments__item comments-item">
                                                ...
                                                <div class="comments-item__img">
                                                    <img class="comments-item__image" src="images/member-icon-19.png"
                                                        alt="img">
                                                </div>
                                        ...
                                        <div class="comments__wrapper">
                                            <div class="comments__item comments-item">
                                                ...
                                                <div class="comments-item__img">
                                                    <img class="comments-item__image" src="images/member-icon-12.png"
                                                        alt="img">
                                                </div>
                                                <div class="comments-item__inner">
                                                    <p class="comments-item__name">
                            ...
                            <div class="group-profile-posts__post post">
                                <div class="post__body post-body">
                                    <div class="post-body__top post-body-top">
                                        <a class="post-body-top__link" href="#">
                                            <img class="post-body-top__link-img" src="images/member-icon-25.png"
                                                alt="img">
                                        </a>
                                        <div class="post-body-top__box">
                                            <p class="post-body-top__box-text">
                                    ...
                                    <div class="post-body__view post-body-view post-body-view--grid">
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/m1.jpg" alt="img">
                                        </a>
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/m2.jpg" alt="img">
                                        </a>
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/m3.jpg" alt="img">
                                        </a>
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/m4.jpg" alt="img">
                                        </a>
                                        <a class="post-body-view__link" href="#">
                                            <img class="post-body-view__link-img" src="images/new/m5.jpg" alt="img">
                                        </a>
                                    </div>
                                    <div class="post-body__info post-body-info">
                                        <div class="post-body-info__box post-body-info-box">
                                    ...
                                    <div class="comments__inner">
                                        <div class="comments__wrapper">
                                            <div class="comments__item comments-item">
                                                ...
                                                <div class="comments-item__img">
                                                    <img class="comments-item__image" src="images/member-icon-28.png"
                                                        alt="img">
                                                </div>
                                                <div class="comments-item__inner">
                                                    <p class="comments-item__name">
                                        ...
                                        <div class="comments__wrapper">
                                            <div class="comments__item comments-item">
                                                ...
                                                <div class="comments-item__img">
                                                    <img class="comments-item__image" src="images/member-icon-10.png"
                                                        alt="img">
                                                </div>
                                                <div class="comments-item__inner">
                                                    <p class="comments-item__name">
                                            ...
                                            <div class="comments__replyed comments-replied">
                                                <div class="comments-replied__item comments-item">
                                                    ...
                                                    <div class="comments-item__img">
                                                        <img class="comments-item__image" src="images/member-icon-3.png"
                                                            alt="img">
                                                    </div>
                                                    <div class="comments-item__inner">
                                                        <p class="comments-item__name">
                            ...
                            <div class="group-profile-posts__post post">
                                <div class="post__body post-body">
                                    <div class="post-body__top post-body-top">
                                        <a class="post-body-top__link" href="#">
                                            <img class="post-body-top__link-img" src="images/member-icon-24.png"
                                                alt="img">
                                        </a>
                                        <div class="post-body-top__box">
                                            <p class="post-body-top__box-text">
                ...
                <div class="group-profile__wrapper" id="2">
                    <section class="group-profile__media group-profile-media">
                        ...
                        <div class="group-profile-media__item group-profile-media-item group-profile-media-item--photos">
                            <div class="group-profile-media-item__top group-profile-media-item-top">
                                <h2 class="group-profile-media-item-top__title">
                                    Photos
                                </h2>
                                <div class="group-profile-media-item-top__buttons group-profile-media-item-top-buttons">
                                    <div class="group-profile-media-item-top-buttons__btn">
                                        <input class="group-profile-media-item-top-buttons__btn-input" type="file">
                            ...
                            <div class="group-profile-media-item__inner">
                                <a class="group-profile-media-item__box group-profile-media-item-box" data-fancybox=""
                                    href="images/group-img-39.jpg">
                                    <img class="group-profile-media-item-box__img" src="images/new/m1.jpg"
                                        alt="img">
                                </a>
                                <a class="group-profile-media-item__box group-profile-media-item-box" data-fancybox=""
                                    href="images/group-img-40.jpg">
                                    <img class="group-profile-media-item-box__img" src="images/new/m2.jpg"
                                        alt="img">
                                </a>
                                <a class="group-profile-media-item__box group-profile-media-item-box" data-fancybox=""
                                    href="images/group-img-41.jpg">
                                    <img class="group-profile-media-item-box__img" src="images/new/m3.jpg"
                                        alt="img">
                                </a>
                            </div>
                        </div>
                        <div class="group-profile-media__item group-profile-media-item group-profile-media-item--videos">
                            <div class="group-profile-media-item__top group-profile-media-item-top">
                                <h2 class="group-profile-media-item-top__title">
                                    Videos
                                </h2>
                        ...
                        <div class="group-profile-media__item group-profile-media-item group-profile-media-item--audios">
                            <div class="group-profile-media-item__top group-profile-media-item-top">
                                <h2 class="group-profile-media-item-top__title">
                                    Audios
                                </h2>
