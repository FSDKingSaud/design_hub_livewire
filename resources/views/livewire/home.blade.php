    ...
    <section class="main__count count">
        <div class="container">
            <div class="count__inner">
                <a class="count__item count-item" href="{{ route('members') }}">
                ...
                <a class="count__item count-item" href="{{ route('groups') }}">
                    <div class="count-item__icon">
                        <svg width="16" height="16" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g id="icons">
                ...
                <a class="count__item count-item" href="{{ route('courses') }}">
                    <div class="count-item__icon">
                        <svg width="16" height="16" viewBox="0 0 12 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g id="icons">
                        ...
                        <div class="groups-section__card card">
                            <div class="card__inner">
                                ...
                                <a class="card-box__poster" href="{{ route('group-page') }}">
                                    <img class="card-box__poster-img" src="images/new/1-1.jpg" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="groups-section-swiper__slide groups-section-slide swiper-slide">
                        <div class="groups-section__card card">
                            <div class="card__inner">
                                ...
                                <a class="card-box__poster" href="{{ route('group-page') }}">
                                    <img class="card-box__poster-img" src="images/new/1-2.jpg" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="groups-section-swiper__slide groups-section-slide swiper-slide">
                        <div class="groups-section__card card">
                            <div class="card__inner">
                                ...
                                <a class="card-box__poster" href="{{ route('group-page') }}">
                                    <img class="card-box__poster-img" src="images/new/1-3.jpg" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="main__new-courses new-courses">
        <div class="container">
            ...
            <div class="portfolio_main">
                ...
                <div class="works_list works_list_col3 ">


                    <div class="work__shout">
                        <a class="work__link-img" href="{{ route('members-portfolio-single') }}">
                            <img src="images/new/ga1.jpg" alt="img">
                            <div class="work__link-image-caption">Wallet App design</div>
                        </a>
                        <div class="work__link-image-user">
                            <div class="work__link-image-avatar">
                                <img class="members-section-top__img-image" src="images/member-icon-16.png"
                                    alt="img">
                            </div>
                            <a href="{{ route('members-portfolio-single') }}"> Elodie Hardin</a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="section-top__inner">
                ...
                <div class="section-top__img">
                    <img class="section-top__img-image" src="images/new/image8885.jpg" alt="img">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="shop-section-swiper__slide shop-section-slide swiper-slide">
                        <div class="shop__card card">
                            <div class="card__inner">
                                <a class="card-box__poster" href="{{ route('shop') }}">
                                ...
                                <a class="card__title" href="{{ route('shop') }}">
                                    Coffee Cup
                                </a>
                                ...
                                <a class="card__link" href="{{ route('shop') }}">
                                    Add to Cart
                                </a>
                            </div>
                        </div>
